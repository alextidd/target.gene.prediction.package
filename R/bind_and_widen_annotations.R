...
#'
#' Bind annotation tibbles and then apply pivot_wider
...
#'
#' @param id.cols Vector of column names that uniquely identifies each observation, sent to pivot_wider(id_cols)
...
#' @export
bind_and_widen_annotations <- function(id.cols, annotation.level, ...){
